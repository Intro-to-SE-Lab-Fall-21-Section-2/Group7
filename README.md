...
2. Inbox
   ...
   - This page indicates if the messages are read or unread using a status indicator in it's own column. There are buttons/links for accessing the inbox, drafting e-mails, accessing deleted e-mails, and additional pages of inbox.
   - The user can logout
